...
\lstdefinestyle{mystyle}{
    ...
    breakatwhitespace=true,          % Quebras apenas em espaços em branco
    breaklines=true,                 % Quebras de linha automáticas
    captionpos=b,                    % Posição da legenda
    commentstyle=\color{codegreen},       % Estilo dos comentários
    deletekeywords={},               % Palavras-chave excluídas
    escapeinside={\%*}{*)},          % Caracteres de escape
    extendedchars=true,              % Permite caracteres estendidos
    frame=single,                    % Moldura ao redor do código
    keepspaces=true,                 % Mantém espaços em branco
    keywordstyle=\color{magenta},       % Estilo das palavras-chave
    language=Python,                 % Linguagem do código
    morekeywords={},                 % Mais palavras-chave a serem destacadas
    numbers=left,                    % Posição dos números de linha
    numbersep=5pt,                   % Distância dos números de linha ao código
    numberstyle=\tiny\color{codegray},   % Estilo dos números de linha
    rulecolor=\color{black},         % Cor da moldura
    showspaces=false,                % Mostra espaços em branco
    showstringspaces=false,          % Mostra espaços em branco em strings
    showtabs=false,                  % Mostra tabulações
    stepnumber=1,                    % Passo entre os números de linha
    stringstyle=\color{green},       % Estilo das strings
    tabsize=4,                       % Tamanho da tabulação
    title=\lstname,                  % Mostra o nome do arquivo
    xleftmargin=16pt,                % Margem esquerda
    framexleftmargin=16pt            % Margem esquerda da moldura
}
